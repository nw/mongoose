...
Model = this.Model = Class({
  ...
  init: function(doc, hydrate){
    _define(this, '__doc', this._schema());
  ...
  _cast: function(type,val){
    switch(type){
      ...
      case Number: 
        ...
        break;
      case ObjectID:
        val = (val instanceof ObjectID) ? val : (val.length == 24) ? new ObjectID(val) : new ObjectID();
        break;
...
(function(){
  ...
  var _compileProperties = function(props,_arr,path){
    var _props = props || [], _ret = {}, prop, field, p;
